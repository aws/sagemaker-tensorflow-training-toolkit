...
def test_keras_training(sagemaker_local_session, docker_image, tmpdir):
    ...
    random_port = randint(1025, 65535)
    sagemaker_local_session.config = {'local': {'serving_port': random_port}}
    sagemaker_local_session.sagemaker_runtime_client.serving_port = random_port
